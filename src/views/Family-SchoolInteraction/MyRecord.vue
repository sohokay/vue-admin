<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-waves class="filter-item" type="primary" icon="el-icon-search">
        <router-link :to="{name:'EditSchoolNoticeList'}">发布通知</router-link>
      ...
      <el-table-column label="操作" align="center" min-width="230" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          ...
          <el-button type="primary" size="mini">
            <router-link :to="{name:'UpdateSchoolNoticeList',params: { id:row.id}}"> 编辑</router-link>

          </el-button>
          <el-button type="success" size="mini" @click="reportTheLossDialog=true">
            审核
          </el-button>
          <el-button type="danger" size="mini" @click="cancelReportTheLoss(row)">
            删除
          </el-button>
